            ...
            <div className="library-hero-card">
                <div className="library-hero-content">
                    ...
                    <div className="library-hero-text">
                        <h1 className="library-hero-title text-4xl font-serif font-bold">You library</h1>
                    ...
                    <div className="library-hero-illustration-desktop">
                        <Image src="/assets/hero-illustration.png"
                    ...
                    {/* Center part - Mobiile (Hidden on Desktop)  */}
                            ...
                            <li className="library-step-item">
                                <div className="w-10 h-10 min-w-10 min-h-10 rounded-full border border-gray-300 flex items-center justify-center font-medium text-lg ">1</div>
                                    <div className="flex flex-col">
                                        ...
                                        <p className="library-step-description text-gray-500">Add you book</p>
                                    </div>
                            </li>
                             <li className="library-step-item">
