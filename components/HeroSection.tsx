            ...
            <div className="library-hero-card">
                <div className="library-hero-content">
                    ...
                    <div className="library-hero-text">
                        ...
                        <Link href="/books/new" className="library-cta-primary mt-4 flex items-center justify-center relative z-20">
                    ...
                    {/* Center Part - Desktop */}
                    <div className="library-hero-illustration-desktop pointer-events-none">
                        <Image
                    ...
                    <div className="library-hero-illustration pointer-events-none">
                        <Image
                            src="/assets/hero-illustration.png"
                            alt="Vintage books and a globe"
                            width={300}
